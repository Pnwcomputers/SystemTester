...
# What's New in v3.0 — Malware & Threat Detection

**PNWC Portable Sysinternals System Tester** now goes beyond hardware diagnostics: v3.0 adds a full malware triage layer built on Sysinternals Autoruns, Sigcheck, ListDLLs, and Process Explorer, plus a Windows Event Log threat audit — all integrated into the existing report and recommendations engine.

> v3.0 is a triage aid for bench technicians. It is **not** a replacement for a full antivirus/EDR scan — it tells you *where to look first*.
