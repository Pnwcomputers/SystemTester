...
## v3.1 — Self-Aware Threat Scan (current)

The threat scan no longer trips over its own execution. Because this tool *contains* threat-hunting keywords and *runs* PowerShell, earlier builds would flag themselves — a real finding could get buried under the tool's own noise. v3.1 fixes that:
